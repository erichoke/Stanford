% Run program and use interface to open background file, the program will
% print the background value you should subtract from your other files.

function read_phd_bg()
final_res=0.2;
bgValue=0;
...
fitfirstns=30; % (ns) fit the first few ns after maximum for initial decay
endstart=0.7; %fit this from fraction of total data to end for the final decay lifetime
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
phdfiles=strcat(pathname, filename); %List of all files to process
...
aver=round(final_res/Resolution(1));
...
%     legend('data',strcat('t_0=',num2str(-1/logp1(n,1)),' ns'), strcat('t_n=',num2str(-1/logp2(n,1)),' ns'))
%     hold off    
% end
...
% xlswrite(filepath, {'a0*exp(-t/t0)';'t0';'a0';'tn';'an'}, 'LifeTimeFit', 'A1')
